...
function addNewReleaseTableRow(definitionId, releaseTitle, releaseId, badgeTitleColor) {
    ...
    { 
        ...
        prodStatusIconId1: releaseId + "-" + ENVIRONMENT_PRD1 + "-status-icon",
        prodStatusIconId2: releaseId + "-" + ENVIRONMENT_PRD2 + "-status-icon",
        ...
        prodStatusTextId1: releaseId + "-" + ENVIRONMENT_PRD1 + "-status-text",
        prodStatusTextId2: releaseId + "-" + ENVIRONMENT_PRD2 + "-status-text",

...
function getReleaseDefinition(definitionId, definitionName) {
    ...
    $.ajax({
        ...
        getLastSucceededDeploymentInfo(definitionName, cssId, ENVIRONMENT_DEV1, developmentDefinitionEnvironmentId);
        getLastSucceededDeploymentInfo(definitionName, cssId, ENVIRONMENT_QA1, qualityDefinitionEnvironmentId);
        getLastSucceededDeploymentInfo(definitionName, cssId, ENVIRONMENT_STG1, stagingDefinitionEnvironmentId);
        getLastSucceededDeploymentInfo(definitionName, cssId, ENVIRONMENT_PRD1, productionDefinitionEnvironmentId);
 ...
 */
function getLastSucceededDeploymentInfo(definitionName, cssId, environment, definitionEnvironmentId) {

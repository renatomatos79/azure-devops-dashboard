...
function getReleaseDefinitions(appItem) {
    ...
    $.ajax({
        ...
        releaseList.forEach((releaseItem, index) => {
            ...
            getCardDefinition(appItem, releaseItem.definitionId, releaseItem.definitionName, truncateBuildNumber);
        });
 ...
 */
function getCardDefinition(appItem, definitionId, definitionName, truncateBuildNumber) {
    ...
    $.ajax({
        ...
        getLastSucceededDeploymentInfo(appItem, definitionName, cssId, ENVIRONMENT_DEV1, developmentDefinitionEnvironmentId, truncateBuildNumber);
        getLastSucceededDeploymentInfo(appItem, definitionName, cssId, ENVIRONMENT_QA1, qualityDefinitionEnvironmentId, truncateBuildNumber);
        getLastSucceededDeploymentInfo(appItem, definitionName, cssId, ENVIRONMENT_STG1, stagingDefinitionEnvironmentId, truncateBuildNumber);
        getLastSucceededDeploymentInfo(appItem, definitionName, cssId, ENVIRONMENT_PRD1, productionDefinitionEnvironmentId, truncateBuildNumber);
 ...
 */
function getLastSucceededDeploymentInfo(appItem, definitionName, cssId, environment, definitionEnvironmentId, truncateBuildNumber) {
...
function addCardDefinition(appItem, releaseItem, releaseId, color) {
    ...
    { 
        app: appItem,
        release: releaseItem,
        isPrincipal: releaseItem.isPrincipal,
        releaseId: releaseId,

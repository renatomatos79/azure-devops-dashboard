    ...
    httpClient.get(uri, { params: { data: {
        ...
        if (principalList.length > 0) {
            ...
            principalList.forEach((releaseItem, index) => {
                // TODO: usar após persistir os dados na base
                // const card = addCardDefinition(responseAppItem, releaseItem);
                
                // const callbackCardAdded = function(card, environment, content){

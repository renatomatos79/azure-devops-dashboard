var app = new Vue({
    ...
    data: {
      ...
      cards: [],
      apps: [
        { id: "biz", path: "\\1-BIZ", prefix: "vNext - DEV BIZ", title: "BIZ", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "warning", truncateBuildNumber: false },
        { id: "ott", path: "\\2-OTT", prefix: "vNext - DEV OTT", title: "OTT", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "success", truncateBuildNumber: false },
        { id: "sf", path: "\\3-SF", prefix: "SF", title: "SF", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "info", truncateBuildNumber: true },
        { id: "player", path: "\\4-PLAYER", prefix: "vNext - DEV Player", title: "PLAYER", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "dark", truncateBuildNumber: false },
        { id: "bom", path: "\\5-BOM", prefix: "vNext - DEV BOM", title: "BOM", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "secondary", truncateBuildNumber: false },
        { id: "azr", path: "\\6-AZR", prefix: "vNext - DEV AZR", title: "AZR", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "danger", truncateBuildNumber: false },
        { id: "ovx", path: "\\7-OVX", prefix: "vNext - DEV OVX", title: "OVX", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "primary", truncateBuildNumber: false }
      ],
    },
    computed: {

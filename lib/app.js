var app = new Vue({
    ...
    data: {
      ...
      cards: [],
      apps: [
        { id: "azr",    path: "\\6-AZR",    searchContent: "AZR",    prefix: "vNext - DEV AZR",     sufix: "AZR Deployment with DSC",    title: "AZR", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "danger", truncateBuildNumber: false, isRunning: false, margin: 'py-3 pl-3' },
        { id: "biz",    path: "\\1-BIZ",    searchContent: "BIZ",    prefix: "vNext - DEV BIZ",     sufix: "BIZ Deployment with DSC",    title: "BIZ", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "warning", truncateBuildNumber: false, isRunning: false, margin: 'py-3 pl-4' },
        { id: "bom",    path: "\\5-BOM",    searchContent: "BOM",    prefix: "vNext - DEV BOM",     sufix: "BOM Deployment with DSC",    title: "BOM", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "secondary", truncateBuildNumber: false, isRunning: false, margin: 'py-3 pl-3' },
        { id: "ott",    path: "\\2-OTT",    searchContent: "OTT",    prefix: "vNext - DEV OTT",     sufix: "OTT Deployment with DSC",    title: "OTT", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "success", truncateBuildNumber: false, isRunning: false, margin: 'py-3 pl-3' },
        { id: "ovx",    path: "\\7-OVX",    searchContent: "OVX",    prefix: "vNext - DEV OVX",     sufix: "OVX Deployment with DSC",    title: "OVX", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "primary", truncateBuildNumber: false, isRunning: false, margin: 'py-3 pl-3' },
        { id: "player", path: "\\4-PLAYER", searchContent: "Player", prefix: "vNext - DEV Player",  sufix: "Player Deployment with DSC", title: "PLAYER", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "dark", truncateBuildNumber: false, isRunning: false, margin: 'py-3 pl-2' },
        { id: "sf",     path: "\\3-SF",     searchContent: "SF",     prefix: "SF",                  sufix: "",                           title: "SF", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "info", truncateBuildNumber: true, isRunning: false, margin: 'py-3 pl-4' }
      ],
    },
    computed: {

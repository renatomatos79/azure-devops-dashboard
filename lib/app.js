var app = new Vue({
    el: '#app',
    data: {
      title: 'Releases MediaHub - Overview v1.0.27',
      filtered: false,
      isVssReady: false,
      lasAppItemId: "",
      filterContent: "",
      ...
      apps: [
        ...
        { id: "player", path: "\\4-PLAYER", prefix: "vNext - DEV Player", title: "PLAYER", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "dark" },
        ...
        { id: "azr", path: "\\6-AZR", prefix: "vNext - DEV AZR", title: "AZR", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "danger" },

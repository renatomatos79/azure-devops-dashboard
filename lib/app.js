var app = new Vue({
    el: '#app',
    data: {
      title: 'Releases MediaHub - v1.0.58',
      filtered: false,
      settings: {
        show: false,
        showMore: false,
      ...
      cards: [],
      apps: [
        { id: "biz",    path: "\\1-BIZ",    searchContent: "BIZ",    prefix: "vNext - DEV BIZ",     sufix: "BIZ Deployment with DSC",    title: "BIZ", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "warning", truncateBuildNumber: false, isRunning: false, margin: 'mt-0' },
        ...
        { id: "player", path: "\\4-PLAYER", searchContent: "Player", prefix: "vNext - DEV Player",  sufix: "Player Deployment with DSC", title: "PLAYER", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false, color: "dark", truncateBuildNumber: false, isRunning: false, margin: 'mt-2' },

var app = new Vue({
    ...
    data: {
      ...
      cards: [],
      apps: [
        { id: "sf", path: "\\3-SF", prefix: "SF", title: "SF", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false },
        { id: "biz", path: "\\1-BIZ", prefix: "vNext - DEV BIZ", title: "DEV BIZ", visible: false, releaseList: [], isReleaseListLoaded: false, checkItems: false }
      ],      
    },
